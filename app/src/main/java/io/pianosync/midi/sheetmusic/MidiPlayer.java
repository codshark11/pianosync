...
public class MidiPlayer extends LinearLayout {
    ...
    // Drawer removed - MaterialDrawer library not in dependencies
    // If needed, replace with Compose navigation drawer or remove drawer functionality
    private Object drawer; // Placeholder - can be removed if drawer functionality is not needed
    ...
    void init() {
        ...
        settingsButton.setOnClickListener(v -> {
            // Drawer functionality removed - MaterialDrawer library not available
            // TODO: Implement settings navigation using Compose navigation or remove this button
            // if (drawer != null) {
            //     drawer.deselect();
            //     drawer.openDrawer();
            // }
