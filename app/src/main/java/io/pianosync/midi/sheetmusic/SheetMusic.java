...
package io.pianosync.midi.sheetmusic;
...
import io.pianosync.midi.sheetmusic.sheets.AccidSymbol;
import io.pianosync.midi.sheetmusic.sheets.BarSymbol;
import io.pianosync.midi.sheetmusic.sheets.BlankSymbol;
import io.pianosync.midi.sheetmusic.sheets.ChordSymbol;
import io.pianosync.midi.sheetmusic.sheets.Clef;
import io.pianosync.midi.sheetmusic.sheets.ClefMeasures;
import io.pianosync.midi.sheetmusic.sheets.ClefSymbol;
import io.pianosync.midi.sheetmusic.sheets.LyricSymbol;
import io.pianosync.midi.sheetmusic.sheets.MusicSymbol;
import io.pianosync.midi.sheetmusic.sheets.RestSymbol;
import io.pianosync.midi.sheetmusic.sheets.Staff;
import io.pianosync.midi.sheetmusic.sheets.SymbolWidths;
...
public class SheetMusic extends SurfaceView implements SurfaceHolder.Callback, ScrollAnimationListener {
    ...
    public void init(MidiFile file, MidiOptions options) {
        ...
        // Load images for TimeSigSymbol and ClefSymbol before creating symbols
    ...
    onSizeChangedAll(int newwidth, int newheight, int oldwidth, int oldheight) {
        ...
        if (scrollVert) {
            ...
            int playerRatio = 0;
            if (player != null && player.getVisibility() == VISIBLE) {
                playerRatio = 1;
            }
